 ...
 *
 *  DO NOT EDIT THIS FILE   (serveropts.c)
 *
...
#define MAILDIR_DESC      (server_opt_strs+23)
/** Upper-cased name for the maildir option */
#define MAILDIR_NAME      (server_opt_strs+49)
/** Name string for the maildir option */
#define MAILDIR_name      (server_opt_strs+57)
 ...
 */
/* extracted from optmain.tlib near line 728 */

#if defined(TEST_SERVER_OPTS)
/*
...
#else /* NOT defined TEST_SERVER_OPTS */
/*
...
#if defined(TEST_SERVER_OPTS) /* TEST-MAIN-PROCEDURE: */
...
{
    int res = SERVER_EXIT_SUCCESS;
    (void)optionProcess(&serverOptions, argc, argv);
    optionPutShell(&serverOptions);
    res = ferror(stdout);
    if (res != 0)
        fputs("output error writing to stdout\n", stderr);
    return res;
}
#endif  /* TEST_SERVER_OPTS END-TEST-MAIN-PROCEDURE */
...
static void bogus_function(void) {
  ...
  puts(_("server - SMTP Mail Transfer Agent Server\n\
Usage:  %s { -<flag> [<val>] | --<name>[{=| }<val>] }...\n"));
